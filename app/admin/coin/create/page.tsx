...
export default function AddCoin() {
    ...
    const [obverseEngravers, setObverseEngravers] =
        useState<EngraverType | null>(null);
    const [reverseEngravers, setReverseEngravers] =
        useState<EngraverType | null>(null);
    ...
    useEffect(() => {
        if (
            ...
            const currenciesRes = getFilteredCurrencyList(
                currencyList,
                country?.id,
            );
                                            ...
                                            {filteredCurrencies.length ===
                                                ...
                                                <tr>
                                                    ...
                                                    >
                                                        ...
                                                        defined for{' '}
                                                        {country.short_name}. To
                                                        be able to add a coin
                                                        from{' '}
                                                        {country.short_name},
                                                        you must first{' '}
                                                        <Link
