            ...
            <TableBody>
              {periods.map((period) => (
                <TableRow>
                  ...
                  <TableCell>{moment(period.created_at).format('MMM DD, YYYY, HH:mm:ss')}</TableCell>
                  <TableCell>{moment(period.updated_at).format('MMM DD, YYYY, HH:mm:ss')}</TableCell>
                  <TableCell>
                    <Link href={`./edit/${period.id}`}>Edit</Link>
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
