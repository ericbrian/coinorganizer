...
-- CreateIndex
CREATE UNIQUE INDEX "Countries_shortName_key" ON "country"("short_name");
...
-- AddForeignKey
ALTER TABLE "collection" ADD CONSTRAINT "Collections_ownerId_fkey" FOREIGN KEY ("owner_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "mint" ADD CONSTRAINT "Mints_countryId_fkey" FOREIGN KEY ("country_id") REFERENCES "country"("id") ON DELETE SET NULL ON UPDATE CASCADE;
